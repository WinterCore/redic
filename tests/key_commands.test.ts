...
describe("key commands", () => {
  ...
  it("del - returns 1 when key exists", async () => {
  ...
  it("del - returns 0 when key does not exist", async () => {
    const redis = await makeRedis();
  ...
  it("del - key is no longer accessible after deletion", async () => {
    const redis = await makeRedis();
  ...
  it("ttl - returns remaining seconds for key with expiry", async () => {
    const redis = await makeRedis();
  ...
  it("ttl - returns -2 after key is deleted", async () => {
    const redis = await makeRedis();
  ...
  it("ttl - returns seconds when set with PX", async () => {
    const redis = await makeRedis();
  ...
  it("exists - returns 1 for an existing key", async () => {
    const redis = await makeRedis();
  ...
  it("exists - returns 0 for a missing key", async () => {
    const redis = await makeRedis();
  ...
  it("exists - returns 0 for an expired key", async () => {
    const redis = await makeRedis();
  ...
  it("expire - key is gone after the timeout elapses", async () => {
    const redis = await makeRedis();
  ...
  it("expire - a past timeout deletes the key immediately", async () => {
    const redis = await makeRedis();
  ...
  it("expire NX - only sets when the key has no expiry", async () => {
    const redis = await makeRedis();
  ...
  it("expire XX - only sets when the key already has an expiry", async () => {
    const redis = await makeRedis();
  ...
  it("expire GT - only sets when the new expiry is greater", async () => {
    const redis = await makeRedis();
  ...
  it("expire LT - only sets when the new expiry is smaller", async () => {
    const redis = await makeRedis();
